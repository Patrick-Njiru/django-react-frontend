...
class App extends Component {
    ...
    renderItems = () => {
        ...
        return newItems.map(item => (
            <li key={item.id} className="list-group-item d-flex justify-content-between align-items-center">
                <span
                className={`todo-title me-2 w-50 ${
                ...
                <span>
                    <button onClick={() => this.editItem(item)} className="btn btn-secondary me-2">
                        Edit
                    </button>
    ...
    //Edit item
    editItem = (item) => { this.setState({ activeItem: item, modal: !this.state.modal }) }
